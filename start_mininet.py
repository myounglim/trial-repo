...
def createMininetNetwork(G):
    ...
    for from_switch, to_switch in G.edges():
        ...
        net.addLink(node1='s'+str(from_switch), node2='s'+str(to_switch), port1=port_from, port2=port_to)
    ...
    for switch_id in G:
        ...
        net.addLink(node1='s'+str(switch_id), node2='h'+str(switch_id), port1=port_from)
